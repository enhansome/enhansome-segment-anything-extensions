# Awesome-segment-anything-extensions with stars
...
* Segment Anything Model (SAM) official [Repo](https://github.com/facebookresearch/segment-anything) ⭐ 54,692 | 🐛 594 | 🌐 Jupyter Notebook | 📅 2024-09-18
...
* Grounded-Segment-Anything (Combination of Ground-DINO and Segment-Anything) [Repo](https://github.com/IDEA-Research/Grounded-Segment-Anything#grounded-segment-anything) ⭐ 17,704 | 🐛 310 | 🌐 Jupyter Notebook | 📅 2024-09-05
...
* Segment-Any-Anomaly (SAM + GroudingDINO for anomaly detection)[Repo](https://github.com/caoyunkang/Segment-Any-Anomaly) ⭐ 844 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2025-02-22

* Segment Any Point Cloud Sequences (SAM for self-supervised learning on large-scale 3D point clouds) [Repo](https://github.com/youquanl/Segment-Any-Point-Cloud) ⭐ 637 | 🐛 8 | 🌐 Python | 📅 2023-12-16 [ArXiv](https://arxiv.org/abs/2306.09347) [Page](https://ldkong.com/Seal)
...
* Segment and Track Anything (SAM-Track) [Repo](https://github.com/z-x-yang/Segment-and-Track-Anything) ⭐ 3,132 | 🐛 43 | 🌐 Jupyter Notebook | 📅 2026-07-03 [ArXiv](https://arxiv.org/abs/2305.06558)

![image](https://user-images.githubusercontent.com/65257938/232959211-6ee84ad5-a02d-44ca-91d2-17d12b978fb2.png)

* Inpaint/Remove/Fill-Anything (image inpainting meets sam) [Repo](https://github.com/geekyutao/Inpaint-Anything) ⭐ 7,690 | 🐛 115 | 🌐 Jupyter Notebook | 📅 2026-07-29

![image](https://user-images.githubusercontent.com/65257938/233364976-ce36b0bf-3886-47db-a4ec-f97520da6523.png)

* SEEM: Segment Everything Everywhere All at Once [Repo](https://github.com/UX-Decoder/Segment-Everything-Everywhere-All-At-Once) ⭐ 4,794 | 🐛 60 | 🌐 Python | 📅 2024-08-19
...
* Image Editing Anything (SAM + CLIP +StableDiffusion) [Repo](https://github.com/feizc/IEA) ⭐ 114 | 🐛 3 | 🌐 Python | 📅 2023-04-11

![image](https://user-images.githubusercontent.com/65257938/231331898-cfac7986-1638-4059-8bb5-56227256b0a6.png)

* Semantic Segment Anything (SAM for semantic seg) [Repo](https://github.com/fudan-zvg/Semantic-Segment-Anything) ⭐ 2,302 | 🐛 27 | 🌐 Python | 📅 2023-06-07

![image](https://user-images.githubusercontent.com/65257938/231338058-34f36f1d-4aad-404d-8c0c-13a5de3b14c0.png)

* segment-anything-with-clip (SAM + CLIP) [Repo](https://github.com/Curt-Park/segment-anything-with-clip) ⭐ 350 | 🐛 4 | 🌐 Python | 📅 2024-02-19

![image](https://user-images.githubusercontent.com/65257938/230819815-f20f80db-f234-45e3-a9ce-7638c564ce22.png)

* magic-copy (use SAM for foreground mask segmentation) [Repo](https://github.com/kevmo314/magic-copy) ⭐ 2,461 | 🐛 24 | 🌐 TypeScript | 📅 2024-05-06

![image](https://user-images.githubusercontent.com/65257938/230820035-216af991-6cf5-4207-9a25-40e7564a3cd1.png)

* EditAnything (SAM for image generation) [Repo](https://github.com/sail-sg/EditAnything) ⭐ 3,424 | 🐛 45 | 🌐 Python | 📅 2025-02-23

![image](https://user-images.githubusercontent.com/65257938/230915204-70634971-e6cf-4a7c-88f7-388265e9cf3b.png)

* Prompt-Segment-Anything (use SAM for instance segmentation) [Repo](https://github.com/RockeyCoss/Prompt-Segment-Anything) ⭐ 316 | 🐛 5 | 🌐 Python | 📅 2023-04-14

![image](https://user-images.githubusercontent.com/65257938/230820059-77098b16-a15e-4563-8a09-919ab49d3a0f.png)

* sam-mmrotate(use SAM for generating rotated bounding boxes with MMRotate) [Repo](https://github.com/Li-Qingyun/sam-mmrotate) ⭐ 199 | 🐛 0 | 🌐 Python | 📅 2023-07-31

* RefSAM (use SAM for refer image segmentation) [Repo](https://github.com/helblazer811/RefSAM) ⭐ 39 | 🐛 2 | 🌐 Python | 📅 2023-04-07

![image](https://user-images.githubusercontent.com/65257938/230820243-c301554b-bccb-477f-aa28-f69865f6afeb.png)

* Fast-SAM (fast segment-anything) [repo](https://github.com/CASIA-IVA-Lab/FastSAM) ⭐ 8,392 | 🐛 146 | 🌐 Python | 📅 2024-07-30
...
* Mobile-SAM (faster segment-anything) [repo](https://github.com/ChaoningZhang/MobileSAM) ⭐ 5,848 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2026-05-05
...
* Segment-anything-with-image-captioning(sam + image caption) [Repo](https://github.com/bnabis93/segment-anything-image-search) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2023-04-10
...
* semantic drawing with Segment Anything Model (SAM for mask drawing/editing) [Repo](https://github.com/lujiazho/SegDrawer) ⭐ 397 | 🐛 14 | 🌐 Python | 📅 2024-08-01

![image](https://user-images.githubusercontent.com/65257938/230872776-454f7d84-995f-45b3-9586-315199c8aa72.png)

* Segment Anything Model (SAM) in Napari (SAM + Napari) [Repo](https://github.com/MIC-DKFZ/napari-sam) ⭐ 250 | 🐛 12 | 🌐 Python | 📅 2024-03-04

* MOTSAM (MOT+SAM->MOTS)[Repo](https://github.com/BingfengYan/MOTSAM) ⭐ 158 | 🐛 4 | 🌐 Python | 📅 2023-05-29

* Annotation-anything-pipeline (GPT+SAM) [Repo](https://github.com/Yuqifan1117/Annotation-anything-pipeline) ⭐ 85 | 🐛 1 | 🌐 Python | 📅 2023-09-21
  ![image](https://user-images.githubusercontent.com/65257938/230908343-be5840bc-d824-4cbd-b881-9842e2d23844.png)

* SAMCOD (SAM for Camouflaged Object Detection) [Paper](https://arxiv.org/abs/2304.04709) [Repo](https://github.com/luckybird1994/SAMCOD) ⭐ 35 | 🐛 2 | 📅 2023-04-14

![image](https://user-images.githubusercontent.com/65257938/231332215-abacbf73-f2af-4ec9-a36f-0d6d973406ee.png)

* inpainting-anything (SAM + inpainting) [Repo](https://github.com/geekyutao/Inpaint-Anything) ⭐ 7,690 | 🐛 115 | 🌐 Jupyter Notebook | 📅 2026-07-29

![image](https://user-images.githubusercontent.com/65257938/231332320-d8d43a47-e416-404a-bab9-a4bfc7bf82f3.png)

* segment-anything-eo (Earth observation tools for Meta AI Segment Anything) [Repo](https://github.com/aliaksandr960/segment-anything-eo) ⭐ 447 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2025-02-05
...
* Napari plugin of Segment Anything Model (SAM) \[Repo] (<https://github.com/JoOkuma/napari-segment-anything> ⭐ 214 | 🐛 17 | 🌐 Python | 📅 2024-08-29)
...
* AnyLabeling = LabelImg + Labelme + Improved UI + Auto-labeling [Repo](https://github.com/vietanhdev/anylabeling) ⭐ 3,452 | 🐛 90 | 🌐 Python | 📅 2026-08-09

![image](https://user-images.githubusercontent.com/65257938/231440358-7a02df55-b578-4f82-b97e-42f9f8d93373.png)

* Caption-anything (Segment Anything + Visual Captioning + ChatGPT) [Repo](https://github.com/ttengwang/Caption-Anything) ⭐ 1,776 | 🐛 20 | 🌐 Python | 📅 2023-08-29

![image](https://user-images.githubusercontent.com/65257938/231440778-d1ae3cf3-a0ba-448c-adfe-a6fa1648ee20.png)

* Segment-anything-u-specify (using sam + clip to segment anything u specify) [Repo](https://github.com/MaybeShewill-CV/segment-anything-u-specify) ⭐ 182 | 🐛 1 | 🌐 Python | 📅 2023-07-04

![image](https://user-images.githubusercontent.com/65257938/231503241-989932a2-0d9a-4d5c-9f0f-e376c4142f04.png)

* OCR-SAM (SAM for Text, Text Removal and Text Inpainting) [Repo](https://github.com/yeungchenwa/OCR-SAM) ⭐ 590 | 🐛 11 | 🌐 Python | 📅 2024-01-30
...
* grounded-segment-anything-colab [Repo](https://github.com/camenduru/grounded-segment-anything-colab) ⭐ 192 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2023-12-25

![image](https://user-images.githubusercontent.com/65257938/231627733-cc0787ec-d64b-46a2-b2d1-19b6c2c196e9.png)

* SAM Medical Imaging [Repo](https://github.com/amine0110/SAM-Medical-Imaging) ⭐ 119 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2023-04-14
...
* LIME-SAM (SAM +  Explainable Artificial Intelligence) [Repo](https://github.com/jaydeep-work/LIME-SAM) ⭐ 32 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2023-04-13

![image](https://user-images.githubusercontent.com/65257938/231751670-474c8e4f-15f3-4e34-bc12-e28052b3c717.png)

* sam-with-mmdet (SAM+MMDetection) [Repo](https://github.com/liuyanyi/sam-with-mmdet) ⭐ 51 | 🐛 3 | 🌐 Python | 📅 2023-04-12

![image](https://user-images.githubusercontent.com/65257938/231974436-64a1b6f2-70d0-4cc0-a963-67a4ad39def8.png)

* open-tracking (sam + tracking) [Repo](https://github.com/open-mmlab/playground/#-open-tracking) ⭐ 1,238 | 🐛 83 | 🌐 Python | 📅 2024-03-29

![image](https://user-images.githubusercontent.com/65257938/231975263-4d4e33f8-1429-437a-9325-70cf4acc8731.png)

* 3D-Box via Segment Anything (sam for 3D Detection) [Repo](https://github.com/dvlab-research/3D-Box-Segment-Anything) ⭐ 564 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2023-04-18
...
* Transfer-Any-Style (SAM for style transfer) [Repo](https://github.com/Anything-of-anything/Transfer-Any-Style) ⭐ 0 | 🐛 0 | 📅 2023-04-15
...
* track-anything (VOS + sam)[Repo](https://github.com/gaomingqi/Track-Anything) ⭐ 6,991 | 🐛 114 | 🌐 Python | 📅 2025-12-13

![image](https://user-images.githubusercontent.com/65257938/232747440-cce172e1-c7bf-4ecc-9e60-b04f072af16c.png)

* SAM-medical (SAM for medocal image segmentation)[Repo](https://github.com/hitachinsk/SAM-Medical) ⭐ 611 | 🐛 49 | 🌐 Python | 📅 2023-09-02

* relate-anything (relation empowered via SAM) [Repo](https://github.com/Luodian/RelateAnything) ⭐ 471 | 🐛 6 | 🌐 Python | 📅 2023-07-04

![image](https://user-images.githubusercontent.com/65257938/234733689-b4adcf38-b991-4c18-b769-f59148815e65.png)

* Count Anything (SAM for counting) [Repo](https://github.com/ylqi/Count-Anything) ⭐ 183 | 🐛 5 | 🌐 Python | 📅 2023-04-22

![image](https://user-images.githubusercontent.com/65257938/234733985-7c596be4-deb7-4531-a2cb-6077d03b7157.png)

* ShowAnything (SAM + SD for editing) [Repo](https://github.com/showlab/ShowAnything) ⭐ 83 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2023-08-01

![image](https://user-images.githubusercontent.com/65257938/234734142-06a58f22-3823-4027-a34a-2b25c7e7a9d9.png)

* MedSAM (SAM for medicine, training tutorial) [Repo](https://github.com/bowang-lab/MedSAM#model-training-video-tutorial) ⭐ 4,373 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2025-05-07
...
* Instruct to Act (SAM+OpenCLIP for robotics application) [Repo](https://github.com/OpenGVLab/Instruct2Act) ⭐ 374 | 🐛 0 | 🌐 Python | 📅 2024-06-23
...
* finetune-anything (SAM finetuning) [Repo](https://github.com/ziqi-jin/finetune-anything) ⭐ 867 | 🐛 33 | 🌐 Python | 📅 2023-08-05
...
* Detect-AnyShadow (SAM for shadow det) [Repo](https://github.com/harrytea/Detect-AnyShadow) ⭐ 69 | 🐛 7 | 🌐 Python | 📅 2024-11-28
...
* SAD: Segment Any RGBD (SAM+Depth / SAM for RGBD) [Repo](https://github.com/Jun-CEN/SegmentAnyRGBD) ⭐ 867 | 🐛 10 | 🌐 Python | 📅 2023-05-24
...
* SAM-HQ: Segment Anything in High Quality (High Quality Mask with SAM) [Repo](https://github.com/SysCV/SAM-HQ) ⭐ 4,253 | 🐛 110 | 🌐 Jupyter Notebook | 📅 2025-09-12
...
* Calib-anything (SAM for calibration optimization) [Repo](https://github.com/OpenCalib/CalibAnything) ⭐ 365 | 🐛 18 | 🌐 C++ | 📅 2023-10-31
...
* Towards Segmenting Anything That Moves [Repo](https://github.com/achalddave/segment-any-moving) ⭐ 108 | 🐛 4 | 🌐 Python | 📅 2019-12-22

![image](https://user-images.githubusercontent.com/65257938/231467307-93900825-e436-4847-a16f-8fc6d692666e.png)

* SegGPT: Segmenting Everything In Context [Repo](https://github.com/baaivision/Painter) ⭐ 2,593 | 🐛 60 | 🌐 Python | 📅 2024-12-06

![image](https://user-images.githubusercontent.com/65257938/231467850-cae7c7cd-21b6-49df-8c5d-fddd405f24ea.png)

* Painter [Repo](https://github.com/baaivision/Painter) ⭐ 2,593 | 🐛 60 | 🌐 Python | 📅 2024-12-06

![image](https://user-images.githubusercontent.com/65257938/231469147-eb3709a2-08ea-4320-a461-7589a4950683.png)

* Stable Diffusion (High-Resolution Image Synthesis with Latent Diffusion Models) [Repo](https://github.com/CompVis/stable-diffusion) ⭐ 73,303 | 🐛 619 | 🌐 Jupyter Notebook | 📅 2024-06-18

![image](https://user-images.githubusercontent.com/65257938/231468134-747e79ae-9325-4d63-b5a3-ad6676d92757.png)

* ControlNet (Adding Conditional Control to Text-to-Image Diffusion Models.) [Repo](https://github.com/lllyasviel/ControlNet) ⭐ 34,069 | 🐛 460 | 🌐 Python | 📅 2024-02-25 [Paper](https://arxiv.org/abs/2302.05543)

![image](https://user-images.githubusercontent.com/65257938/231468301-ca80309b-1c01-474b-9631-c8297784d611.png)

* image2text powered by CLIP and BLIP [Repo](https://github.com/pharmapsychotic/clip-interrogator) ⭐ 2,982 | 🐛 61 | 🌐 Python | 📅 2024-05-15
